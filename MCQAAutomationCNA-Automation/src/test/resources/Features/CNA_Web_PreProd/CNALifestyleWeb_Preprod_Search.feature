...
Feature: Lifestyle Search page scenarios
  ...
  @CNA_Web_PreProd_86 @CNA_Web_PreProd_87 @Sanity_Web_PreProd @Sanity_Web_PreProdLifestyle @Regression_Web
    @Web_CNAB-1119 @Web_CNAB-1110
  Scenario Outline: Lifestyle Search Overlay Page validation in PreProd
