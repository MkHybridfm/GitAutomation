@iPad_CNA_SignupScenarios
@iPad_QA
Feature: Signup scenarios
  @iPad_CNAB-902 @iPad_CNAB-901 @iPad_CNAB-900 @iPad_CNAB-899 @iPad_CNAB-898
  @iPad_CNA_1201 @Sanity_iPad
  Scenario: Verification of create new meConnect Account in iPad
