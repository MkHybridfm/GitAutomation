@iPad_CNA_LifeStyleScenarios @Luxury
@iPad_QA
Feature: lifeStyle scenarios

  @iPad_CNA_0901 @Sanity_iPad
  Scenario: Validation of toast message on life style Section in iPad
  ...
  @iPad_CNA_0902 @Sanity_iPad
  Scenario: Validation of toast message on luxury Section in iPad
    Given I Launch "CNA iPad" Mobile App in iPad
    Then I Verify "Welcome to" info is displayed on "CNA OnBoarding Screen" in iPad
    Then I Verify "logo-cna-new" Image is displayed on "Manage Notifications Screen" in iPad
    Then I Verify "Explore CNA in a brand new way" info is displayed on "CNA OnBoarding Screen" in iPad
  ...
  @iPad_CNA_0903 @Sanity_iPad
  Scenario: Validation of life style menu section in iPad
    Given I Launch "CNA iPad" Mobile App in iPad
    Then I Verify "Welcome to" info is displayed on "CNA OnBoarding Screen" in iPad
    Then I Verify "logo-cna-new" Image is displayed on "Manage Notifications Screen" in iPad
    Then I Verify "Explore CNA in a brand new way" info is displayed on "CNA OnBoarding Screen" in iPad
    ...
    Then I Verify "Entertainment" info is displayed on "Life Style Menu Screen" in iPad
    Then I Verify "Women" info is displayed on "Life Style Menu Screen" in iPad
    Then I Verify "Wellness" info is displayed on "Life Style Menu Screen" in iPad
    Then I Verify "Living" info is displayed on "Life Style Menu Screen" in iPad
    Then I Verify "Style & Beauty" info is displayed on "Life Style Menu Screen" in iPad
    Then I Verify "Dining" info is displayed on "Life Style Menu Screen" in iPad
    Then I Verify "Travel" info is displayed on "Life Style Menu Screen" in iPad

  @iPad_CNA_0904 @Sanity_iPad
  Scenario: Validation of luxury menu section in iPad
    Given I Launch "CNA iPad" Mobile App in iPad
    Then I Verify "Welcome to" info is displayed on "CNA OnBoarding Screen" in iPad
    Then I Verify "logo-cna-new" Image is displayed on "Manage Notifications Screen" in iPad
    Then I Verify "Explore CNA in a brand new way" info is displayed on "CNA OnBoarding Screen" in iPad
    ...
    Then I Verify "Experiences" info is displayed on "Luxury Menu Screen" in iPad
    Then I Verify "Obsessions" info is displayed on "Luxury Menu Screen" in iPad
    Then I Verify "People" info is displayed on "Luxury Menu Screen" in iPad
    Then I Verify "Remarkable Living" info is displayed on "Luxury Menu Screen" in iPad