...
public class iPadCNADiscoverPage {
    private RemoteWebDriver driver;
    private GlobalConfig objConfig;
    private ActionEngineHelper action;

    public iPadCNADiscoverPage(RemoteWebDriver driver, GlobalConfig objConfig) {
        this.driver = driver;
    ...
    public void initElements() {
        ...
        this.article_DiscoverPage = MobileAppLocator.GetLocator( "//XCUIElementTypeCollectionView//XCUIElementTypeCollectionView//XCUIElementTypeCell", MobileAppLocator.MobileElementType.XCUICustomElement);
        ...
        this.threeDots_DiscoverPage = MobileAppLocator.GetLocator( "(//XCUIElementTypeButton[@name=\"icon menu grey\"])", MobileAppLocator.MobileElementType.XCUICustomElement);
    ...
    public void clickOnArticleOnDiscoverPage() {
            this.action.elementHelper.fnGetListofElement(this.article_DiscoverPage).get(0).click();
    }
