...
public class CNA_Android_LoginPage {
	public RemoteWebDriver driver;
	public GlobalConfig objConfig;
	public ActionEngineHelper action;
	public AppiumDriver mobdriver;

	public CNA_Android_LoginPage(RemoteWebDriver driver, GlobalConfig objConfig) {
		this.driver=driver;
	...
	public void initElements()
	{
		...
		this.gender_edittext=AppLocator.GetLocator(AppLocatorType.GetLocator(ApplicationType.WEB,LocatorStrategy.XPATH, "//div[@class='dk-selected ']"),
				AppLocatorType.GetLocator(ApplicationType.ANDROID_APP,LocatorStrategy.XPATH, "//android.view.ViewGroup/android.view.ViewGroup[4]/android.view.ViewGroup/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.EditText"),
		...
		this.manage_accountSection=AppLocator.GetLocator(AppLocatorType.GetLocator(ApplicationType.ANDROID_APP,LocatorStrategy.ID,"com.channelnewsasia:id/tv_manage_me_connect_account"),
		...
		this.meRewards_accountSection=AppLocator.GetLocator(AppLocatorType.GetLocator(ApplicationType.ANDROID_APP,LocatorStrategy.ID,"com.channelnewsasia:id/tv_me_reward"),
				AppLocatorType.GetLocator(ApplicationType.IOS_APP,LocatorStrategy.XPATH,"//XCUIElementTypeStaticText[@name=\"meRewards\"]"));
		this.username_accountSection=AppLocator.GetLocator(AppLocatorType.GetLocator(ApplicationType.ANDROID_APP,LocatorStrategy.ID,"com.channelnewsasia:id/tv_username"),
	...
	public void loginCredentialsForNewUser() throws InterruptedException {
		...
		Thread.sleep(1000);
		this.action.mobileActionEngineHelper.mobileInteractionHelper.fnPressByCoordinates(115, 580, 1);
	...
	public void logoutFromApp(){
		...
		this.action.mobileActionEngineHelper.mobileInteractionHelper.fnSwipeScreenSmall(MobileInteractionHelper.Direction.UP,6);
	...
	public void clickOnLuxury(){
		this.action.mobileActionEngineHelper.mobileInteractionHelper.fnSwipeScreenSmall(MobileInteractionHelper.Direction.DOWN,6);
	...
	public void clickOnSpecialReports(){
		this.action.mobileActionEngineHelper.mobileInteractionHelper.fnSwipeScreenSmall(MobileInteractionHelper.Direction.UP,12);
	...
	public void clickOnEyeWitness(){
		this.action.mobileActionEngineHelper.mobileInteractionHelper.fnSwipeScreenSmall(MobileInteractionHelper.Direction.UP,13);
	...
	public void clickOnBrandedContent(){
		this.action.mobileActionEngineHelper.mobileInteractionHelper.fnSwipeScreenSmall(MobileInteractionHelper.Direction.UP,14);
