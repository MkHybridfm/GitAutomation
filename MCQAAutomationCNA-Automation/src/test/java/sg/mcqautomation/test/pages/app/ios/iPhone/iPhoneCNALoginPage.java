...
public class iPhoneCNALoginPage {
	public RemoteWebDriver driver;
	public GlobalConfig objConfig;
	public ActionEngineHelper action;
	public AppiumDriver mobdriver;

	public iPhoneCNALoginPage(RemoteWebDriver driver, GlobalConfig objConfig) {
		this.driver=driver;
	...
	public void clickOnLogin() throws InterruptedException {
		this.action.mobileActionEngineHelper.mobileInteractionHelper.fnSwipeScreenBig(Direction.UP);
		this.action.elementHelper.fnClick(this.login_next_button);
		Thread.sleep(1000);
	}
	...
	public boolean validateContactSection() throws InterruptedException {
		this.action.mobileActionEngineHelper.mobileInteractionHelper.ScrollToElement(this.advertiseWithMe_contactSection, MobileInteractionHelper.Direction.UP);
	...
	public boolean validateAboutSection() throws InterruptedException {
		Thread.sleep(5000);
		this.action.mobileActionEngineHelper.mobileInteractionHelper.ScrollToElement(this.aboutSectionLabel, MobileInteractionHelper.Direction.UP);
	...
	public boolean validateLogoutSection(){
		this.action.mobileActionEngineHelper.mobileInteractionHelper.ScrollToElement(this.logout, MobileInteractionHelper.Direction.UP);
	...
	public boolean verifyBrowseAllSec(){
		this.action.mobileActionEngineHelper.mobileInteractionHelper.ScrollToElement(this.browseAllSec, MobileInteractionHelper.Direction.UP);
		return this.action.mobileActionEngineHelper.mobileInteractionHelper.ScrollToElement(this.browseAllSec, MobileInteractionHelper.Direction.UP);
	}

	public void clickOnTopStoriesUnderBrowseAllSec(){
		this.action.mobileActionEngineHelper.mobileInteractionHelper.ScrollToElement(this.topStories_BrowseAll, MobileInteractionHelper.Direction.UP);
	...
	public void clickOnSpecialReports(){
		this.action.mobileActionEngineHelper.mobileInteractionHelper.ScrollToElement(this.specialReports, MobileInteractionHelper.Direction.UP);
		this.action.elementHelper.fnClick(this.specialReports);
	}

	public boolean verifyHeaderOfSpecialReports(){
		return this.action.mobileActionEngineHelper.mobileInteractionHelper.ScrollToElement(this.specialReportsHeader, MobileInteractionHelper.Direction.UP);
	}

	public void clickOnEyeWitness(){
		this.action.mobileActionEngineHelper.mobileInteractionHelper.ScrollToElement(this.eyeWitness_menu, MobileInteractionHelper.Direction.UP);
		this.action.elementHelper.fnClick(this.eyeWitness_menu);
	}

	public void clickOnBrandedContent(){
		this.action.mobileActionEngineHelper.mobileInteractionHelper.ScrollToElement(this.brandedContent, MobileInteractionHelper.Direction.UP);
		this.action.elementHelper.fnClick(this.brandedContent);
	}

	public boolean verifyHeaderOfBrandedContent(){
		return this.action.mobileActionEngineHelper.mobileInteractionHelper.ScrollToElement(this.brandedContentHeader, MobileInteractionHelper.Direction.UP);
	}

	public void clickOkButtonOnSuccessMessagePage(){
		this.action.mobileActionEngineHelper.mobileInteractionHelper.ScrollToElement(this.OkButtonOnSuccessMessagePage, MobileInteractionHelper.Direction.UP);
		this.action.elementHelper.fnClick(this.OkButtonOnSuccessMessagePage);
	}
	...
	public void fnEnterValidPassword() throws InterruptedException {
		this.action.elementHelper.fnClick(this.email_password);
