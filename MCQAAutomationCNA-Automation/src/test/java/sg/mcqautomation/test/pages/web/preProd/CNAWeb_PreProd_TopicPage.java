...
public class CNAWeb_PreProd_TopicPage {
    private RemoteWebDriver driver;
    private GlobalConfig objConfig;
    private ActionEngineHelper action;

    public CNAWeb_PreProd_TopicPage(RemoteWebDriver driver, GlobalConfig objConfig) {
        this.driver = driver;
    ...
    public void initElements() {
        this.worldCategoryArticleFromTopStories = AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.WEB, AppLocatorType.LocatorStrategy.XPATH, "//div[@class='list-object']//h6/a"));
    ...
    public String verifyFollowButtonAfterClick() throws InterruptedException {
        this.action.waitHelper.waitFor(buttonFollowing);
