...
public class iPhoneCNALifeStylePage {
    private RemoteWebDriver driver;
    private GlobalConfig objConfig;
    private ActionEngineHelper action;

    public iPhoneCNALifeStylePage(RemoteWebDriver driver, GlobalConfig objConfig) {
        this.driver = driver;
    ...
    private By articleHome;
    private By article_lifeStyle_List;

    public void initElements() {
        this.article_lifeStyle = MobileAppLocator.GetLocator("//XCUIElementTypeTable/XCUIElementTypeCell[2]/XCUIElementTypeStaticText", MobileAppLocator.MobileElementType.XCUICustomElement);
        this.article_lifeStyle_List = MobileAppLocator.GetLocator("//XCUIElementTypeTable/XCUIElementTypeCell", MobileAppLocator.MobileElementType.XCUICustomElement);
        this.listOfTopics_CNALifeStylePage = MobileAppLocator.GetLocator("//XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeTable/XCUIElementTypeCell//XCUIElementTypeStaticText", MobileAppLocator.MobileElementType.XCUICustomElement);
        ...
        this.listOfTopics_CNALuxuryPage = MobileAppLocator.GetLocator( "//XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeTable/XCUIElementTypeCell", MobileAppLocator.MobileElementType.XCUICustomElement);
        ...
        this.articleHome= MobileAppLocator.GetLocator("(//XCUIElementTypeButton[@name='icon menu grey'])[1]//..", MobileAppLocator.MobileElementType.XCUICustomElement);
}
    ...
    public boolean verifyarticle() throws InterruptedException {
        Thread.sleep(6000);
        this.action.mobileActionEngineHelper.mobileInteractionHelper.ScrollToElement(this.article_lifeStyle_List);
        return this.action.elementHelper.fnGetListofElement(this.article_lifeStyle_List).size()>5;
    }

    public boolean verifyListOfSectionsUnderTheLifeStyleMenuPage(){
        try {
            return this.action.elementHelper.fnGetListofElement(this.listOfTopics_CNALifeStylePage).size()>0;
        }
    ...
    public boolean validateListOfTopicsOnLuxurySec(){
        try {
            return this.action.elementHelper.fnGetListofElement(this.listOfTopics_CNALuxuryPage).size()>0;
        }
        catch (Exception e){return false;}
    }
    ...
    public void clickOnArticleHome(){
        this.action.elementHelper.fnClick(this.articleHome);
    }
}