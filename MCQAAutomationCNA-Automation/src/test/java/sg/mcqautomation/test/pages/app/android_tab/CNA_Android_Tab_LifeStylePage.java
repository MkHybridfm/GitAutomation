...
public class CNA_Android_Tab_LifeStylePage {
    private RemoteWebDriver driver;
    private GlobalConfig objConfig;
    private ActionEngineHelper action;

    public CNA_Android_Tab_LifeStylePage(RemoteWebDriver driver, GlobalConfig objConfig) {
        this.driver = driver;
    ...
    public void initElements() {
        ...
        this.article_lifeStyle = AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.ANDROID_APP, AppLocatorType.LocatorStrategy.ID, "item_thumbnail_story"),
    ...
    public void clickOnArticle() throws InterruptedException {
        ...
        for (int i = 0; i <= 10; i++) {
            ...
            if (this.action.elementHelper.fnIsElementPresent(article_lifeStyle)) {
                break;
            }
        }
