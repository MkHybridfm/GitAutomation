...
public class CNA_MobileWeb_Android_Lifestyle_ArticleDetailPage {

    private RemoteWebDriver driver;
    private GlobalConfig objConfig;
    private ActionEngineHelper action;

    public CNA_MobileWeb_Android_Lifestyle_ArticleDetailPage(RemoteWebDriver driver, GlobalConfig objConfig) {
        this.driver = driver;
    ...
    public void initElements() {
        this.articleLinkFromTopStories = AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.ANDROID_WEB, AppLocatorType.LocatorStrategy.XPATH, "//h2/a"));
        this.articlePageAuthourBlock = AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.ANDROID_WEB, AppLocatorType.LocatorStrategy.XPATH, "//section[@class[contains(.,'articlefield-author')]]"));
        this.articlePageShareOptions = AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.ANDROID_WEB, AppLocatorType.LocatorStrategy.XPATH, "//div[@class='js-popup-content with-authors']"));
        this.alsoWorthReadingSection = AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.ANDROID_WEB, AppLocatorType.LocatorStrategy.XPATH, "//h2[contains(.,'RECOMMENDED')]"));
        this.outBrainSection = AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.ANDROID_WEB, AppLocatorType.LocatorStrategy.XPATH, "//div[@class='OUTBRAIN']"));
    }
    ...
    public void clickOnlatestnewsArticle() throws InterruptedException {
        ...
        //this.action.javaScriptHelper.fnJSClick(driver,articleLinkFromTopStories));
    }
