...
public class iPadCNAMyFeedPage {
    private RemoteWebDriver driver;
    private GlobalConfig objConfig;
    private ActionEngineHelper action;

    public iPadCNAMyFeedPage(RemoteWebDriver driver, GlobalConfig objConfig) {
        this.driver = driver;
    ...
    public void initElements() {
        ...
        this.myfeedList = MobileAppLocator.GetLocator("//XCUIElementTypeCollectionView//XCUIElementTypeCell", MobileAppLocator.MobileElementType.XCUICustomElement);
        ...
        this.myTopicList = MobileAppLocator.GetLocator( "//XCUIElementTypeTable//XCUIElementTypeCell", MobileAppLocator.MobileElementType.XCUICustomElement);
        this.myTopicListHome = MobileAppLocator.GetLocator( "//XCUIElementTypeStaticText[@name='Add topics to create your personal news feed.']//..//XCUIElementTypeCollectionView//XCUIElementTypeCell", MobileAppLocator.MobileElementType.XCUICustomElement);
    ...
    public String getMyTopicFeedListName(){
         ...
         return elementList.get(elementList.size()-1).findElements(By.xpath("//XCUIElementTypeStaticText")).get(0).getText();
    }
