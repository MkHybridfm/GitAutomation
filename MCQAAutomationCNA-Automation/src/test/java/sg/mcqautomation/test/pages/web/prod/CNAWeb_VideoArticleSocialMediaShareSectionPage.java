...
public class CNAWeb_VideoArticleSocialMediaShareSectionPage {

    private RemoteWebDriver driver;
    private GlobalConfig objConfig;
    private ActionEngineHelper action;

    public CNAWeb_VideoArticleSocialMediaShareSectionPage(RemoteWebDriver driver, GlobalConfig objConfig) {
        this.driver = driver;
