...
public class iPhoneCNAListenPage {
    private RemoteWebDriver driver;
    private GlobalConfig objConfig;
    private ActionEngineHelper action;

    public iPhoneCNAListenPage(RemoteWebDriver driver, GlobalConfig objConfig) {
        this.driver = driver;
    ...
    public void initElements() {
        ...
        this.contentTitleOnListenPage = MobileAppLocator.GetLocator( "//XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeTable/XCUIElementTypeCell[2]/XCUIElementTypeStaticText[1]", MobileAppLocator.MobileElementType.XCUICustomElement);
    ...
    public boolean verifyShareOptions() {
        this.action.waitHelper.fnWaitForVisibilityOf(this.shareOnListenPage);
        return this.action.elementHelper.fnIsElementPresent(this.shareOnListenPage);
    }

    public boolean verifyBookmarkOptions() {
        this.action.waitHelper.fnWaitForVisibilityOf(this.bookbarkOption);
