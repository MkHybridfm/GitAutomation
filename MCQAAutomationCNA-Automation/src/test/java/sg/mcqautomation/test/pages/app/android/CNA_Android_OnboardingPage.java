...
public class CNA_Android_OnboardingPage {
    private RemoteWebDriver driver;
    private GlobalConfig objConfig;
    private ActionEngineHelper action;

    public CNA_Android_OnboardingPage(RemoteWebDriver driver, GlobalConfig objConfig) {
        this.driver = driver;
    ...
    public void initElements() {
        ...
        this.trendingTopicList = AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.ANDROID_APP, AppLocatorType.LocatorStrategy.XPATH, "//android.widget.TextView[@resource-id='com.channelnewsasia:id/tv_topic']"));
        ...
        this.moreTopicsList = AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.ANDROID_APP, AppLocatorType.LocatorStrategy.XPATH, "//androidx.recyclerview.widget.RecyclerView[@resource-id='com.channelnewsasia:id/rv_more_topics']/android.widget.TextView"));
    ...
    public boolean validateCNALogo(){
        return this.action.elementHelper.fnIsElementPresent(cnaLogo);
    }
}
