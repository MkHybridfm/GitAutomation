...
public class CNA_Android_Tab_DiscoverPage {
    private RemoteWebDriver driver;
    private GlobalConfig objConfig;
    private ActionEngineHelper action;

    public CNA_Android_Tab_DiscoverPage(RemoteWebDriver driver, GlobalConfig objConfig) {
        this.driver = driver;
    ...
    public void initElements() {
        ...
        this.surpriseMe = AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.ANDROID_APP, AppLocatorType.LocatorStrategy.ID, "com.channelnewsasia:id/bt_surprise_me"),
        ...
        this.headerOnDiscoverPage = AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.ANDROID_APP, AppLocatorType.LocatorStrategy.XPATH, "//android.widget.TextView[contains(@text,'Editor')]"),
        ...
        this.backButton = AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.ANDROID_APP, AppLocatorType.LocatorStrategy.ID, "iv_back"),
                AppLocatorType.GetLocator(GlobalConfig.ApplicationType.IOS_APP, AppLocatorType.LocatorStrategy.XPATH, "//XCUIElementTypeButton[@name=\"icon back\"]"));
        this.threeDots_Discover = AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.ANDROID_APP, AppLocatorType.LocatorStrategy.ID, "com.channelnewsasia:id/discover_big_picture"));
        this.threeDots_DiscoverPage = AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.ANDROID_APP, AppLocatorType.LocatorStrategy.XPATH, "//android.view.ViewGroup[@resource-id='com.channelnewsasia:id/item_featured_story']/android.widget.ImageView[@resource-id='com.channelnewsasia:id/iv_options'] "),
    ...
    public boolean validateSurpriseMeFunctionality() throws InterruptedException {
       this.action.mobileActionEngineHelper.mobileInteractionHelper.ScrollToElement(surpriseMe);
    ...
    public void clickOnThreeDotsOnDiscoverPage(){
        this.action.mobileActionEngineHelper.mobileInteractionHelper.ScrollToElement(threeDots_Discover);
