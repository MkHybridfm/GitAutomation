...
public class CNAWeb_PreProd_SearchPage {

    private RemoteWebDriver driver;
    private GlobalConfig objConfig;
    private ActionEngineHelper action;

    public CNAWeb_PreProd_SearchPage(RemoteWebDriver driver, GlobalConfig objConfig) {
        this.driver = driver;
    ...
    public void enter3CharactersInSearchTextBox() throws AWTException, InterruptedException {
        Thread.sleep(2000);
        this.action.javaScriptHelper.fnJSType(searchTextBox, "co");
        this.action.elementHelper.fnType(searchTextBox, "v");
    }
