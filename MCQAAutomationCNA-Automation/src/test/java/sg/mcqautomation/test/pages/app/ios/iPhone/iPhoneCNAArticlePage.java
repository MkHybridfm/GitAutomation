...
public class iPhoneCNAArticlePage {

    private RemoteWebDriver driver;
    private GlobalConfig objConfig;
    private ActionEngineHelper action;

    public iPhoneCNAArticlePage(RemoteWebDriver driver, GlobalConfig objConfig) {
        this.driver = driver;
    ...
    private By relatedTopicListLuxry;

    public void initElements() {
        this.articleSection = MobileAppLocator.GetLocator("//XCUIElementTypeScrollView/XCUIElementTypeOther/XCUIElementTypeTable/XCUIElementTypeCell[5]", MobileAppLocator.MobileElementType.XCUICustomElement);
        this.okButton_articleSection = MobileAppLocator.GetLocator("OK", MobileAppLocator.MobileElementType.XCUIElementTypeButton);
        this.articleTitle= MobileAppLocator.GetLocator("//XCUIElementTypeCollectionView//XCUIElementTypeStaticText", MobileAppLocator.MobileElementType.XCUICustomElement);
        this.moreArticles_ArticlePage= MobileAppLocator.GetLocator( "//XCUIElementTypeCollectionView/XCUIElementTypeCell[3]/XCUIElementTypeOther/XCUIElementTypeImage", MobileAppLocator.MobileElementType.XCUICustomElement);
        ...
        this.relatedTopicListLuxry=MobileAppLocator.GetLocator( "//XCUIElementTypeStaticText[contains(@name,'RELATED TOPICS')]//..//..//..//..//XCUIElementTypeCollectionView//XCUIElementTypeCell", MobileAppLocator.MobileElementType.XCUICustomElement);
    }
    ...
    public boolean verifyArticleContentTitle() throws InterruptedException {
        Thread.sleep(5000);
        return this.action.elementHelper.fnIsElementPresent(this.articleTitle);
    }
    ...
    public boolean verifyRelatedTopicsHeader(String strText) throws InterruptedException {
        ...
        if(this.action.elementHelper.fnIsElementPresent(locOption))
            return true;
        else
        {
            locOption =MobileAppLocator.GetLocator(strText.toUpperCase(), MobileAppLocator.MobileElementType.XCUIElementTypeStaticText);
            if(this.action.elementHelper.fnIsElementPresent(locOption))
                return true;
            else {
                locOption = MobileAppLocator.GetLocator(WordUtils.capitalizeFully(strText), MobileAppLocator.MobileElementType.XCUIElementTypeStaticText);
                return this.action.elementHelper.fnIsElementPresent(locOption);
            }
        }
    }

    public boolean verifyRelatedTopicsLuxry() throws InterruptedException {
        this.action.mobileActionEngineHelper.mobileInteractionHelper.ScrollToElement(this.relatedTopicListLuxry, MobileInteractionHelper.Direction.UP);
        return this.action.elementHelper.fnGetListofElement(this.relatedTopicListLuxry).size()>0;
    }

    public String GetRelatedTopicsNameLuxry() throws InterruptedException {
        this.action.mobileActionEngineHelper.mobileInteractionHelper.ScrollToElement(this.relatedTopicListLuxry, MobileInteractionHelper.Direction.UP);
        return this.action.elementHelper.fnGetListofElement(this.relatedTopicListLuxry).get(0).findElement(By.xpath("//XCUIElementTypeStaticText")).getText();
    }

    public void selectRelatedTopicsLuxry() throws InterruptedException {
        this.action.mobileActionEngineHelper.mobileInteractionHelper.ScrollToElement(this.relatedTopicListLuxry, MobileInteractionHelper.Direction.UP);
        this.action.elementHelper.fnGetListofElement(this.relatedTopicListLuxry).get(0).click();
    }
}
