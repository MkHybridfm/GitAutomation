...
public class CNA_Android_Tab_MyFeedPage {
    private RemoteWebDriver driver;
    private GlobalConfig objConfig;
    private ActionEngineHelper action;

    public CNA_Android_Tab_MyFeedPage(RemoteWebDriver driver, GlobalConfig objConfig) {
        this.driver = driver;
    ...
    public void initElements() {
        ...
        this.topicsHeaderHomePage = AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.ANDROID_APP, AppLocatorType.LocatorStrategy.XPATH, "//android.widget.TextView[@text='Personalize My Feed'][@resource-id='com.channelnewsasia:id/tv_name']"));
        ...
        this.fromMyFeedHeader = AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.ANDROID_APP, AppLocatorType.LocatorStrategy.XPATH, "//android.widget.TextView[@text='From My Feed'][@resource-id='com.channelnewsasia:id/tv_name']"));
        this.fromMyFeedArticleList = AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.ANDROID_APP, AppLocatorType.LocatorStrategy.XPATH, "//androidx.recyclerview.widget.RecyclerView[@resource-id='com.channelnewsasia:id/rv_my_feed']/android.widget.LinearLayout"));
    ...
    public void scrollToTopicsSectionHomePage(){
        this.action.mobileActionEngineHelper.mobileInteractionHelper.ScrollToElement(createMyFeedButton);
    }
    ...
    public void selectTopics() throws InterruptedException {
        ...
        this.action.elementHelper.fnClick(loc);
        Thread.sleep(1000);
        this.action.elementHelper.fnClick(loc1);
    }
