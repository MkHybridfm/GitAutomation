...
public class iPadCNAWatchPage {
    private RemoteWebDriver driver;
    private GlobalConfig objConfig;
    private ActionEngineHelper action;

    public iPadCNAWatchPage(RemoteWebDriver driver, GlobalConfig objConfig) {
        this.driver = driver;
    ...
    public void initElements() {
        ...
        this.latestEpisodeOnWatch = MobileAppLocator.GetLocator( "(//XCUIElementTypeButton[@name='icon menu grey'])[1]//..//..", MobileAppLocator.MobileElementType.XCUICustomElement);
        ...
        this.videocontrolsound=MobileAppLocator.GetLocator( "//XCUIElementTypeCollectionView//XCUIElementTypeCell//XCUIElementTypeOther//XCUIElementTypeOther//XCUIElementTypeButton", MobileAppLocator.MobileElementType.XCUICustomElement);
        this.Latest = MobileAppLocator.GetLocator( "//XCUIElementTypeStaticText[@name='Latest' and @visible ='true']", MobileAppLocator.MobileElementType.XCUICustomElement);
    }
    ...
    public void clickOnLatestEpisode() {
        this.action.mobileActionEngineHelper.mobileInteractionHelper.ScrollToElement(this.Latest);
