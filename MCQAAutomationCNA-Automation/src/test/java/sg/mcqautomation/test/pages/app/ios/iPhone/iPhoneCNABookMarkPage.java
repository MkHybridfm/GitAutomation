...
public class iPhoneCNABookMarkPage {
    private RemoteWebDriver driver;
    private GlobalConfig objConfig;
    private ActionEngineHelper action;

    public iPhoneCNABookMarkPage(RemoteWebDriver driver, GlobalConfig objConfig) {
        this.driver = driver;
    ...
    public boolean validateBookmarkList(){
    ...
    public void clickArticle(){
        this.action.elementHelper.fnClick(this.bookmarkedArticleList);
    }
