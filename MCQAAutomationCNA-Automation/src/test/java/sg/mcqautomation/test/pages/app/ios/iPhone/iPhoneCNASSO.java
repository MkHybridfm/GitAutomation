...
public class iPhoneCNASSO {
    private RemoteWebDriver driver;
    private GlobalConfig objConfig;
    private ActionEngineHelper action;

    public iPhoneCNASSO(RemoteWebDriver driver, GlobalConfig objConfig) {
        this.driver = driver;
    ...
    public void initElements() {
        this.PRCNAPrefTrendingTopicsList = MobileAppLocator.GetLocator("//XCUIElementTypeScrollView/XCUIElementTypeOther/XCUIElementTypeButton", MobileAppLocator.MobileElementType.XCUICustomElement);
...
//Tell us what you like and we will recommend content to you based on your preferences.
    ...
    {
        this.action.elementHelper.fnClick(PRCNAPrefTrendingTopicsList);
       /* List<WebElement> eleList=this.action.elementHelper.fnGetListofElement(this.PRCNAPrefTrendingTopicsList);
        if(eleList.size()>0)
        {
    ...
    {
        this.action.elementHelper.fnClick(PRCNAPrefMoreTopicsOptionList);
