...
public class CNAWeb_PreProd_NewsLetterSubscriptionPage {
    private RemoteWebDriver driver;
    private GlobalConfig objConfig;
    private ActionEngineHelper action;

    public CNAWeb_PreProd_NewsLetterSubscriptionPage(RemoteWebDriver driver, GlobalConfig objConfig) {
        this.driver = driver;
    ...
    public void clickOnSubscribeButton() throws InterruptedException {
        Thread.sleep(2000);
        this.action.javaScriptHelper.fnJSScrollToView(emailAddressText);
        Thread.sleep(2000);
        this.action.actionHelper.fnActionMouseMove(emailAddressText);
