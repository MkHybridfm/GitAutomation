...
public class CNA_Android_ArticlePage {

    private RemoteWebDriver driver;
    private GlobalConfig objConfig;
    private ActionEngineHelper action;

    public CNA_Android_ArticlePage(RemoteWebDriver driver, GlobalConfig objConfig) {
        this.driver = driver;
    ...
    public void initElements() {
        ...
        this.moreArticles_ArticlePage= AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.ANDROID_APP, AppLocatorType.LocatorStrategy.XPATH, "//android.widget.TextView[@text[contains(.,'Swipe for more articles')]]"),
        ...
        this.relatedTopics_ArticlePage= AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.ANDROID_APP, AppLocatorType.LocatorStrategy.XPATH, "//android.widget.TextView[contains(@text,'Related Topics')]"),
        ...
        this.article_commentarySec= AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.ANDROID_APP, AppLocatorType.LocatorStrategy.XPATH, "//androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView[2]/android.widget.LinearLayout[1]/android.view.ViewGroup"),
        ...
        this.listOfTopics_menuSec= AppLocator.GetLocator(AppLocatorType.GetLocator(GlobalConfig.ApplicationType.ANDROID_APP, AppLocatorType.LocatorStrategy.ID, "com.channelnewsasia:id/tv_trending_topic"),
    ...
    public boolean verifyArticleContentTitle(){
    ...
    public String verifySectionWithWorthReading(){
        for(int i=0;i<=25;i++) {
            try {
                this.action.mobileActionEngineHelper.mobileInteractionHelper.fnSwipeScreenSmall(MobileInteractionHelper.Direction.UP, 1);
                if (this.action.elementHelper.fnIsElementDisplayed(alsoWorthReading_ArticlePage))
                    break;
            }
            catch (Exception e){
            }
    ...
    public boolean verifySectionWithOutBrainRecommended(){
        for(int i=0;i<=25;i++) {
            try {
                ...
                if (this.action.elementHelper.fnIsElementDisplayed(outBrain_ArticlePage))
                    break;
            }
            catch (Exception e){
            }
        }
        return this.action.elementHelper.fnIsElementDisplayed(outBrain_ArticlePage);
    }
    ...
    public void clickOnArticleOnCommentarySec() {
        ...
        for (int i = 0; i <= 25; i++) {
            try {
                this.action.mobileActionEngineHelper.mobileInteractionHelper.fnSwipeScreenSmall(MobileInteractionHelper.Direction.UP, 2);
                if (this.action.elementHelper.fnIsElementPresent(article_commentarySec)) {
    ...
    public boolean verifyLabelOnCNALuxury() {
        if (this.objConfig.applicationType == GlobalConfig.ApplicationType.IOS_APP) {
            ...
            for (int i = 0; i <= 25; i++) {
                try {
                    this.action.mobileActionEngineHelper.mobileInteractionHelper.fnSwipeScreenSmall(MobileInteractionHelper.Direction.UP, 2);
                    if (this.action.elementHelper.fnIsElementPresent(relatedTopicOnCnaLuxury)) {
                        blnStatus = true;
                        break;
                    } else {
    ...
    public boolean verifyAuthorNameOnTheArticlePage(){
        ...
        for (int i = 0; i <= 10; i++) {
            try {
                this.action.mobileActionEngineHelper.mobileInteractionHelper.fnSwipeScreenSmall(MobileInteractionHelper.Direction.UP, 2);
                if (this.action.elementHelper.fnIsElementPresent(authorLink)) {
                    break;
                }
            } catch (Exception e) {
            }
       ...
       // this.action.waitHelper.waitFor(authorLink);
       return this.action.elementHelper.fnIsElementDisplayed(authorLink);
    }
