...
import sg.mcqautomation.test.pages.web.mobileWeb.Android.CNA_MobileWeb_Android_BookmarkPage;

public class CNA_MobileWeb_Android_BookmarkSteps {

    CNA_MobileWeb_Android_BookmarkPage CNAWeb_BookmarkPage = new CNA_MobileWeb_Android_BookmarkPage(DriverFactory.getDriver(),
    ...
    @When("I click on Bookmarked tab in Android Mobile Web")
    public void iClickOnBookmarkedTab() {
        CNAWeb_BookmarkPage.clickOnBookmarkedTab();
    }

    @And("I validate if {string} message is displayed in Android Mobile Web")
    ...
    @Then("I click on Bookmark option for a Top Story from Landing Page in Android Mobile Web")
    ...
    @And("I validate if {string} toast message is displayed in Android Mobile Web")
    ...
    @And("I validate if Bookmark button is changed to {string} in Android Mobile Web")
    ...
    @And("I validate the status of Bookmark Option is {string} in Android Mobile Web")
    ...
    @And("I click on My feed section for loggedIn user in Android Mobile Web")
    ...
    @And("I click on Bookmark Link from Profile popup screen in Android Mobile Web")
    ...
    public void iClickOnThreeDotsOfAArticleFromCNALandingPageInAndroidMobileWeb() {
