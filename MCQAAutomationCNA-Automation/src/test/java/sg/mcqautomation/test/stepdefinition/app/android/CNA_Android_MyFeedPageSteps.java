...
public class CNA_Android_MyFeedPageSteps {
    ...
    @Then("I validate {string} info in My Feed Screen in Android App")
    ...
    @Then("I Verify {string} Screen in Android App")
    ...
    @Then("I Verify {string} Tab in Manage Feed Screen in Android App")
    public void iVerifyTabInManageFeedScreenInAndroidApp(String tab) {
        Assert.assertTrue(cnaMyFeedPage.validateMyTopicsTab(tab));
    }

    @When("I Click {string} Tab in Manage Feed Screen in Android App")
    ...
    public void iValidateIfTopicsTitleAndAddTopicsContextIsDisplayedForMyFeedInHomePageInAndroidApp() {
        cnaMyFeedPage.validateTopicsTitleAddTopicsText();
    }
    ...
    public void iValidateFromMyFeedTitleInAndriodApp() {
