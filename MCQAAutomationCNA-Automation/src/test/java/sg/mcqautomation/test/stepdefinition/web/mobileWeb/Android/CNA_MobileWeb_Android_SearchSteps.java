...
import sg.mcqautomation.test.pages.web.mobileWeb.Android.CNA_MobileWeb_Android_SearchPage;

import java.awt.*;

public class CNA_MobileWeb_Android_SearchSteps {

    CNA_MobileWeb_Android_SearchPage CNAWeb_SearchPage = new CNA_MobileWeb_Android_SearchPage(DriverFactory.getDriver(),
    ...
    @Then("I enter the content to search in Search Text field {string} in Android Mobile Web")
    ...
    @Then("I click on one of the trending Topics from Sugesstion in Android Mobile Web")
