...
public class CNA_MobileWeb_IOS_LoginSteps {
    ...
    @When("I log into web application with invalid username {string} and password {string} in IOS Mobile Web")
    ...
    @Then("I See Error Message as {string} in IOS Mobile Web")
