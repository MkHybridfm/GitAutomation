...
import sg.mcqautomation.test.pages.app.android_tab.CNA_Android_Tab_DiscoverPage;

public class CNA_Android_Tab_DiscoverPageSteps {

    CNA_Android_Tab_DiscoverPage cnaDiscoverPage = new CNA_Android_Tab_DiscoverPage(DriverFactory.getDriver(),
    ...
    @Then("I redirected to discover page in app view in Android App in Tab")
