...
import sg.mcqautomation.test.pages.app.android_tab.CNA_Android_Tab_WatchPage;

public class CNA_Android_Tab_WatchPageSteps {

    CNA_Android_Tab_WatchPage cnaWatchPage = new CNA_Android_Tab_WatchPage(DriverFactory.getDriver(),
            DriverFactory.getGlobalConfig());

    public SoftAssertions softAssert =new SoftAssertions();

    @And("I click on watch section in Android App in Tab")
    ...
    @Then("I validate the label displayed with {string} in Android App in Tab")
    ...
    @Then("I verify the fields with {string} and {string} in Android App in Tab")
